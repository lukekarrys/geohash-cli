...
var _yargs$alias$default$alias$default$alias$default$alias$default$alias$default$version = _yargs2['default'].alias('o', 'open')['default']('o', false).alias('p', 'pretty')['default']('p', false).alias('j', 'json')['default']('j', false).alias('t', 'table')['default']('t', false).alias('h', 'help')['default']('h', false).version(_package.version);

var argv = _yargs$alias$default$alias$default$alias$default$alias$default$alias$default$version.argv;
